...
import com.workuser.https.SSLClient;
...
//            client = HttpClients.createDefault();
             ...
             * 设置请求头部编码
             */
            httpGet.setHeader(new BasicHeader("Content-Type", "multipart/form-data; boundary=----WebKitFormBoundary7MA4YWxkTrZu0gW"));
            ...
            System.out.println("HttpClientService-line: {}, Exception: {}");
        } finally {
            response.close();
            client.close();
        }
    ...
    public static Object sendPost(String url, List<NameValuePair> nameValuePairList) throws Exception{
        ...
        try{
             ...
             * 设置请求的报文头部的编码
             */
            post.setHeader(new BasicHeader("Content-Type", "multipart/form-data; boundary=----WebKitFormBoundary7MA4YWxkTrZu0gW"));
            ...
            if (SUCCESS_CODE == statusCode){
                ...
                System.out.println("HttpClientService-line: {}, errorMsg：{} POST请求失败！");
            }
        }catch (Exception e){
            System.out.println("HttpClientService-line: {}, Exception：{}");
        }finally {
    ...
    public static List<NameValuePair> getParams(Object[] params, Object[] values){
        ...
        if (flag){
            ...
            System.out.println("HttpClientService-line: {}, errorMsg：{} 请求参数为空且参数长度不一致");
        }
        return null;
    }
}
